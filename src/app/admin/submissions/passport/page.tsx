...
async function getData() {
  try {
    ...
    console.error('Error fetching passport submissions:', err);
...
export default async function AdminPassportSubmissionsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-[#142921]">مشاركات مسار: أفضل جواز سفر</h1>
        <p className="text-xs sm:text-sm text-[#62776D] mt-1">
          عاين المشاركات وقم بتأكيد استلام جوازات السفر المسلمة يدويًا للمشرفين
        </p>
      </div>
